...
const Navbar = ({clickPreview, clickSummary, clickWork, clickProjects}: NavbarProps) => {
  return (
    <ul className="flex justify-evenly">
      <li className="flex-1 text-center bg-red-400 hover:bg-red-300 transition-colors duration-300 ease-out rounded-l-2xl">
        <button className="w-full py-4 " type="button" onClick={clickPreview}>Preview</button>
      </li>
